...
PATTERNS = [
    ...
    },
    {
        ...
        "category": "Creational",
        "analogy": "A manufacturer decides which factory to use based on a bulk order.",
        "summary": "Abstract Factory creates families of related products. One manufacturer picks a sedan line or SUV line and gets matching parts together.",
