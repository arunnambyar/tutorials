...
- [Internet and NAT gateways](./1220_igw_nat.md)
- [Security groups and NACLs](./1230_security_groups_nacls.md)
- [VPC peering and endpoints](./1240_peering_endpoints.md)
- [ALB and NLB](./1250_load_balancing.md)
- [Route 53](./1260_route53.md)

## M4 Compute — VMs & autoscaling

- [EC2](./1300_ec2.md)
- [AMIs and instance types](./1310_amis_instance_types.md)
- [Launch templates](./1320_launch_templates.md)
- [Auto Scaling groups](./1330_auto_scaling_groups.md)
...
- [RDS](./1500_rds.md)
- [DynamoDB](./1510_dynamodb.md)

## M7 Serverless functions

- [Lambda](./1600_lambda.md)
...
- [SNS](./1810_sns.md)
- [Amazon MQ](./1820_amazon_mq.md)
- [MSK](./1830_msk.md)
- [EventBridge](./1840_eventbridge.md)

## M11 Scalable background jobs

- [Queue workers](./1900_queue_workers.md)
- [AWS Batch](./1910_aws_batch.md)
- [Step Functions](./1920_step_functions.md)
- [Scheduled and cron jobs](./1930_scheduled_jobs.md)

## M12 API management

- [API Gateway](./2000_api_gateway.md)

## M13 Observability

- [CloudWatch](./2100_cloudwatch.md)
- [X-Ray](./2110_xray.md)

## M14 Ops & IaC

- [CloudFormation and CDK](./2200_cloudformation_cdk.md)
